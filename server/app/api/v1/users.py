...
from app.api.deps import get_db, require_root
...
async def toggle_user_active(
    ...
    user = await user_service.update_user(user_id, is_active=not user.is_active)
    status_text = "启用" if user.is_active else "禁用"
    return {"message": f"已{status_text}账号", "is_active": user.is_active}
